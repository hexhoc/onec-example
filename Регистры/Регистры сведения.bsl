...
Процедура ПрочитатьНаборЗаписей()
	...
	// Управляемый режим блокировок. Разделяемая блокировка
...
Процедура ОчиститьЗаписиВНезависимомРегистреСведенийСОтбором1(Валюта, БазоваяВалюта)
...
Процедура ОчиститьЗаписиВНезависимомРегистреСведенийСОтбором2(Валюта, БазоваяВалюта)
...
Процедура ОчиститьЗаписиВЗависимомРегистреСведений(Регистратор)
	Набор = РегистрыСведений.ЦеныНоменклатуры.СоздатьНаборЗаписей();
	Набор.Отбор.Регистратор.Установить(Регистратор);
	Набор.Записать();
КонецПроцедуры

Процедура ОчиститьЗаписиВЗависимомРегистреСведенийСОтбором(Регистратор, Номенклатура)
	Набор = РегистрыСведений.ЦеныНоменклатуры.СоздатьНаборЗаписей();
	Набор.Отбор.Регистратор.Установить(Регистратор);
	Набор.Прочитать();
...
Процедура ОчиститьВсеЗаписиРегистраСведений()
	Набор = РегистрыСведений.КурсыВалют.СоздатьНаборЗаписей();
	Набор.Записать();
КонецПроцедуры